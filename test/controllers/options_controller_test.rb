...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { checked: @option.checked, op1: @option.op1, op2: @option.op2, search_id: @option.search_id, value: @option.value } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { checked: @option.checked, op1: @option.op1, op2: @option.op2, search_id: @option.search_id, value: @option.value } }
