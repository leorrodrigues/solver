...
class CloudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloud" do
    assert_difference('Cloud.count') do
      post clouds_url, params: { cloud: { cpu: @cloud.cpu, ram: @cloud.ram, storage: @cloud.storage, vm: @cloud.vm } }
    end
  ...
  test "should update cloud" do
    patch cloud_url(@cloud), params: { cloud: { cpu: @cloud.cpu, ram: @cloud.ram, storage: @cloud.storage, vm: @cloud.vm } }
